...
class TasksController extends BaseController
{
     ...
     * Create Task 🐻
     *
     * @param Models\CreateTaskDTO $body
     *
     * @return Models\TasksResponse Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function tasksControllerCreateTask(Models\CreateTaskDTO $body): Models\TasksResponse
    {
        ...
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'TasksResponse');
    }
}
