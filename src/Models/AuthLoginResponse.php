...
class AuthLoginResponse implements \JsonSerializable
{
    /**
     * @var float
     */
     ...
     * Returns Data.
     */
    public function getData(): ?ResponseLoginDTO
    {
        return $this->data;
    }
     ...
     * @maps data
     */
    public function setData(?ResponseLoginDTO $data): void
    {
        $this->data = $data;
    }
