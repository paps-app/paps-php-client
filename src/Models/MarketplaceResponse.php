...
class MarketplaceResponse implements \JsonSerializable
{
    /**
     * @var float
     */
     ...
     * Returns Data.
     */
    public function getData(): ?GetRateResponseDTO
    {
        return $this->data;
    }
     ...
     * @maps data
     */
    public function setData(?GetRateResponseDTO $data): void
    {
        $this->data = $data;
    }
